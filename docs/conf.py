...
project = u'dhdt'
copyright = u'2023, Netherlands eScience Center, Utrecht University'
author = u"Bas Altena"
...
#
vals = {}
with open(f"{root}/{project}/__version__.py", "r") as f:
    exec(f.read(), {}, vals)
# The short X.Y version.
version = vals.get("__version__", "0.0.0")
# The full version, including alpha/beta/rc tags.
release = vals.get("__version__", "0.0.0")
