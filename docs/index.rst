...
Consequently, functions for the [Sentinel-2](https://en.wikipedia.org/wiki/Sentinel-2) satellites of the [Copernicus](https://en.wikipedia.org/wiki/Copernicus_Programme) system are closest to completion.
