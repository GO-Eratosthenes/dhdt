...
**dhdt** is a modular `geodetic imaging <https://en.wikipedia.org/wiki/Remote_sensing#Geodetic>`_ framework written in Python.
...
Consequently, functions for the `Sentinel-2 <https://en.wikipedia.org/wiki/Sentinel-2>`_ satellites of the `Copernicus <https://en.wikipedia.org/wiki/Copernicus_Programme>`_ system are closest to completion.
...
* `photogrammetry <https://en.wikipedia.org/wiki/Photogrammetry>`_ : extracting displacement or disparity through changes in observation time and of angle
