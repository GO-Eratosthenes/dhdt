...
def list_central_wavelength_as():
    ...
    name = {"B01": 'blue',               "B02" : 'green',
            "B3B" : 'red',               "B3N" : 'red',
            "B04" : 'shortwave infrared',"B05" : 'shortwave infrared',
            "B06" : 'shortwave infrared',"B07" : 'shortwave infrared',
            "B08" : 'shortwave infrared',"B09" : 'shortwave infrared',
            "B10" : 'thermal infrared',  "B11" : 'thermal infrared',
            "B12" : 'thermal infrared',  "B13" : 'thermal infrared',
            "B13": 'thermal infrared',
            }
    d = {
         "wavelength": pd.Series(wavelength),
         "bandwidth": pd.Series(bandwidth),
         "resolution": pd.Series(resolution),
         "viewangle": pd.Series(viewangle),
         "name": pd.Series(name),
