...
def snow_cover_fraction(Near, Short):
    ...
    [1] Paul et al. "The new remote-sensing-derived Swiss glacier inventory: I
    methods" Annuals of glaciology, vol.34 pp.355-361, 2002.
    """   
...
def snow_fraction(Red, Short):
    ...
    [1] Paul & K. "Perspectives on the production of a glacier inventory from
    multispectral satellite data in Arctic Canada: Cumberland peninsula, Baffin
    Island" Annuals of glaciology, vol.42 pp.59-66, 2005.
    """   
...
def normalized_difference_snow_ice_index(Red, Short):
    ...
    mapping snow and ice cover: A normalized snow and ice index" International
    journal of remote sensing, vol.22(13) pp.2479-2487, 2001.
    """   
