...
from eratosthenes.presentation.terrain_tools import luminance_perspective, \
    contrast_perspective
...
Shd_1 =  make_shading(dir_path, Z_file, M_dir, M_name, Zn=Zn_1, Az=Az_1)
Shd_1 = (Shd_1+1)/2

Zn_2,Az_2 = 90-17.7, 165 # 25 Oct 2019 

Shd_2 =  make_shading(dir_path, Z_file, M_dir, M_name, Zn=Zn_2, Az=Az_2)
Shd_2 = (Shd_2+1)/2
...
Shd_bras = luminance_perspective(Shd, Z, .5, k=5)
Shd_jen = contrast_perspective(Shd, Z, .7, 2000, v_min=0.3, k=2)
