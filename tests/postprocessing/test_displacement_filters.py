...
def test_nan_resistant_filter(m=40, n=30, nan_frac=0.1, tsize=3):
    ...
    Z_dx, Z_dy = ndimage.convolve(Z, fx, mode='reflect'), \
                 ndimage.convolve(Z, fy, mode='reflect')
    Z_dx, Z_dy = Z_dx[pad:-pad,pad:-pad], Z_dy[pad:-pad,pad:-pad]
    ...
    Z_dx_nan, Z_dy_nan = nan_resistant_filter(Z, fx), \
                         nan_resistant_filter(Z, fy)
    Z_dx_nan, Z_dy_nan = Z_dx_nan[pad:-pad,pad:-pad], \
                         Z_dy_nan[pad:-pad,pad:-pad]
